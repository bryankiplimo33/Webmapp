...
ax.text(0.5, 0.3, "Interpolation for\nPrecipitation Data", ha="center", va="center", bbox=start_node_style)
...
# Draw dashed arrow for interpolation
ax.annotate("", xy=(0.5, 0.35), xytext=(0.5, 0.28), arrowprops=dict(arrowstyle="-", linestyle="--", color="black"))

# Add labels for interpolation
ax.text(0.5, 0.38, "Kriging Interpolation\nfor Precipitation Data", ha="center", va="center", bbox=node_style)
